                                ...
                                <div className='flex flex-col items-center space-y-6 pt-4'>
                                    ...
                                    <div>
                                        ...
                                        <div className='pt-6'>
                                            ...
                                            <Link to="/"><button onClick={() => { dispatch(modifytest1bool(false)); dispatch(modifytest2bool(false)); dispatch(modifytest3bool(false)) }} className='bg-[#B8621B] hover:bg-blue-900 text-[#E3CCAE] h-12 w-32 flex flex-row items-center justify-center'>Logout</button></Link>
                            ...
                            <div className="flex flex-col lg:w-[70%]   mt-8 space-y-5">
                                ...
                                {activeTab === 1 && (<div className='flex flex-col w-full  space-y-4'>
                                    <div className='flex flex-col items-center w-full sm:space-x-7 sm:flex-row space-y-4 sm:space-y-0'>
                                        ...
                                        {test2bool && (<div className='sm:w-[48%] w-[100%]'><Result2 /></div>)}
                                    </div>
                                    {test3bool && (<div className='sm:w-[48%] w-[100%]'>
                                        <Result3 /> </div>)}
                                </div>)}
                            </div>
                        </div>
