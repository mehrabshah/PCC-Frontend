                    ...
                    <div className=" h-full bg-[#262A56]   box-border ml-4 mr-4 ">
                        <div className='wrapper  flex flex-col  h-full  items-center / justify-center '>
                            <div className=" flex  items-center justify-center flex-col space-y-4 md:flex-row-reverse md:w-[80%] md:h-screen  " >
                                <div className='left md:w-[50%]   md:h-full md:flex md:items-center md:justify-center xl:bg-[#B8621B]  xl:h-[31rem] xl:w-[31rem] xl:rounded-[30rem]'>
                                    <img src="./images/Hero.svg" alt="Hero" className='h-[384px] w-[400px]'></img>
                                </div>
                              
                                <div className='right    space-y-8 text-6xl  md:w-[50%] font-extrabold  md:h-full md:flex md:items-center md:justify-center md:flex-col '>
                                    <h1 className='text-[#E3CCAE] / text-center'>Pyschometric Career Counsellor</h1>
                                    <p className='text-center text-xl text-[#E3CCAE] / font-light / xl:block hidden '>System that assists students in deciding a career path that is suitable for them
                                   System that assists students</p>
                                   <button className='bg-[#B8621B] h-12 / w-60 text-[#E3CCAE] text-xl    xl:block hidden'>Click Here</button>
                ...
                <div className='lg:max-w-5xl lg:mx-auto md:bg-black z-0'>
                    <div className=' box-border bg-[#f8fafb] md:bg-black / z-0 '>
                        <div className='wrapper flex items-center justify-center '>
                            <div className='/  flex flex-col items-center justify-center space-y-4 md:space-y-0 lg:flex-row lg:items-center lg:justify-center 
