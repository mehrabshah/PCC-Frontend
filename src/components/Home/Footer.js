...
<>
  ...
  <footer className="bg-[#262A56] text-center text-[#E3CCAE]">
    <div className="container px-6 pt-6 mx-auto">
      ...
      <div className="mb-6 flex justify-center items-center">
        <a
          href="#!"
          type="button"
          className="m-1 h-9 w-9 rounded-full border-2 border-[#E3CCAE] uppercase leading-normal text-[#E3CCAE] transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
          data-te-ripple-init=""
    ...
    >
      © 2023 Copyright:
      <a className="text-[#E3CCAE]" href="https://tailwind-elements.com/">
        Psychometric
      </a>
    </div>
  </footer>
