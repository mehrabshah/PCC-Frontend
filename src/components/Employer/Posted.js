        ...
        <div className="flex flex-col  pt-8 pb-2 pl-4 pr-4 space-y-2">
          ...
          <div className="flex flex-row space-x-4 ">
            ...
            <div className="flex flex-col">
              <div className="text-[#E3CCAE] text-3xl font-bold">
                Mehrab Ali
              </div>
              <div className="text-[#E3CCAE]">
                Hr executive with more than 4 years of experience
              </div>
            </div>
          </div>
          {/* Job Title */}
          <div className="text-[#E3CCAE]">{props.jobTitle}</div>
          {/* Job Tags */}
          <div className="text-[#E3CCAE]">{props.jobDescription}</div>
          {/* Job Description */}
          <div className="text-[#E3CCAE]">{props.jobTags}</div>
          {/* Job Image */}
          <div>
            <img
