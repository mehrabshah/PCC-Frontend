  ...
  const rendertest = tests.map((test) => (
    <div key={test.id} className="flex-col flex space-y-4">
      <div className="flex flex-row justify-between items-center space-y-4">
        <div className="text-3xl">{test.name}</div>
        <div>
      ...
      <div className="h-[0.01rem]  bg-black w-72"></div>
    </div>
  ));
              ...
              <div className=" mt-8 pt-8 pb-8 lg:w-[30vw] bg-[#262A56] h-[90%] border  border-gray-200 ">
                ...
                <div className="flex flex-col items-center space-y-6 ">
                  ...
                  <div className="flex flex-row / space-x-4">
                    <div
                      className="flex items-center justify-center / h-12 text-xl bg-[#B8621B] w-24 text-white hover:bg-blue-900"
                  ...
                  <div className="h-[0.09rem] text-[#E3CCAE] w-72"></div>
                  <Link to="/">
                    {' '}
                    <div>
                      <button className="bg-[#B8621B] h-11  hover:bg-blue-900  w-32 text-[#E3CCAE] ">
                        Logout
                      </button>
                    </div>
                  </Link>
