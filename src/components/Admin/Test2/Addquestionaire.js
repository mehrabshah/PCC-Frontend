...
import { test2AddQuestion } from '../../../redux/test2Questionaire';
      ...
      <div className='w-full h-96 bg-[#262A56] rounded-2xl'>
          <div className='flex flex-row  justify-center  w-full h-full items-center'>
            <div className='flex flex-col justify-center items-start / space-y-4'>
                ...
                <button  className="bg-[#B8621B] h-10 hover:bg-blue-900 text-[#E3CCAE] w-32" onClick={()=>{dispatch(test2AddQuestion(text))}}>Add</button>
            </div> 
          </div>
      </div>
    </>
